...
//            MenuItem(name: "Raw Media Data".localized, storyboard: "RawMediaData", controller: "RawMediaData"),
    ...
    override func viewDidLoad() {
        ...
        Floaty.global.show()
//        let simpleItem =  MenuItem(name: "Simple Filter Extension".localized, storyboard: "SimpleFilter", controller: "SimpleFilter")
//        let indexPath = menus["Anvanced"][simpleItem]
        self.tableView(self.tableView, didSelectRowAt: IndexPath(row: 13, section: 1))
